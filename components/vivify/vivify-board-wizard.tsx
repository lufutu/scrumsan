...
import { Plus, X, ChevronRight, ChevronLeft, Kanban, Calendar, Upload, Loader2, Building2, FolderOpen, LayoutGrid } from 'lucide-react'
import { cn } from '@/lib/utils'

interface VivifyBoardWizardProps {
  projectId?: string
...
export default function VivifyBoardWizard({ 
  projectId, 
  organizationId, 
  onSuccess, 
  children 
}: VivifyBoardWizardProps) {
  ...
  const handleCreateBoard = async () => {
    ...
    try {
      ...
      const boardData: any = {
        name: wizardData.boardName.trim() || `${wizardData.boardType.charAt(0).toUpperCase() + wizardData.boardType.slice(1)} PTA`,
      ...
      if (template?.columns) {
        ...
        defaultColumns = wizardData.boardType === 'kanban' 
          ...
          : [
              ...
              { name: 'Sprint 1', position: 1 },
              { name: 'Follow up', position: 2 }
            ]
      }
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="border-2 border-dashed border-teal-300 rounded-lg p-8 text-center hover:border-teal-200 transition-colors">
                <input
                  ref={boardLogoRef}
                  type="file"
                  accept="image/*"
                ...
                {wizardData.boardLogoPreview ? (
                  ...
                  <div className="space-y-3">
                    <Upload className="h-12 w-12 mx-auto text-teal-200" />
                    <div>
            ...
            <div className="space-y-4">
              <div className="border-2 border-dashed border-teal-300 rounded-lg p-8 text-center hover:border-teal-200 transition-colors">
                ...
                {wizardData.projectLogoPreview ? (
                  <div className="space-y-3">
                    <div className="mx-auto h-24 w-24 bg-teal-700 rounded-lg flex items-center justify-center overflow-hidden">
                      <img 
                  ...
                  <div className="space-y-3">
                    <div className="mx-auto h-24 w-24 bg-teal-700 rounded-lg flex items-center justify-center">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <div className="w-full p-3 bg-white/10 border border-white/30 rounded-md text-sm text-white">
                    <div className="flex items-center gap-2">
                      <Building2 className="h-4 w-4" />
                                             {activeOrg?.name || 'My Organization'}
                    </div>
                    <ChevronRight className="absolute right-3 top-3 h-4 w-4 text-white/60" />
                  </div>
                </div>
        ...
        return (
          <div className="space-y-6">
            <div className="text-center space-y-4">
              ...
              <div>
                                 <p className="text-sm text-teal-200">{activeOrg?.name || 'My Organization'}</p>
            ...
            <div className="p-4 bg-white/10 rounded-lg border-l-4 border-white">
              <p className="text-sm text-teal-100">
                A Board with a Product Backlog, Sprints (periods of time during which you 
                plan to do some amount of work organized into Items) and Burndown charts. Ideal 
                for Scrum framework users and for organizing work into several periods.
              </p>
            </div>
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[600px] sm:max-h-[700px] bg-gradient-to-br from-teal-500 to-teal-600 border-0 p-0">
          ...
          <div className="flex justify-between pt-4 border-t border-white/20">
            ...
            {currentStep < totalSteps ? (
              <Button 
                onClick={handleNext}
                disabled={!canProceed()}
                className="bg-white text-teal-600 hover:bg-white/90 font-medium"
              >
                Next
