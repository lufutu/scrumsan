...
const STEP_NAMES = ['Board Logo', 'Board Type', 'Project Logo', 'New Project', 'Summary']
...
export default function VivifyBoardCreationWizard({ 
  ...
  const totalSteps = projectId ? 3 : 5 // Skip project steps if we have a projectId
  ...
  const canProceed = () => {
    switch (currentStep) {
      case 1: return true // Board logo is optional
      case 2: return wizardData.boardType !== null
      case 3: return true // Project logo is optional
  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      case 3:
        // Project Logo (only if creating new project)
        return (
          <div className="space-y-6">
            <div className="text-center space-y-4">
              <div className="flex items-center justify-center">
