...
export function ExpandableNav({ className }: ExpandableNavProps) {
  ...
  console.log('ExpandableNav: organizations:', organizations.map(org => ({ id: org.id, slug: org.slug, name: org.name })))
  console.log('ExpandableNav: organizationIds:', organizationIds)
  const { data: orgData, isLoading } = useOptimizedNavDataMultiple(organizationIds)
  console.log('ExpandableNav: orgData:', orgData, 'isLoading:', isLoading)
